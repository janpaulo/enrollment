...
class StudentSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_subject" do
    assert_difference('StudentSubject.count') do
      post student_subjects_url, params: { student_subject: { firts_sem: @student_subject.firts_sem, fourth_sem: @student_subject.fourth_sem, second_sem: @student_subject.second_sem, stud_id: @student_subject.stud_id, subject_id: @student_subject.subject_id, trird_sem: @student_subject.trird_sem } }
    end
  ...
  test "should update student_subject" do
    patch student_subject_url(@student_subject), params: { student_subject: { firts_sem: @student_subject.firts_sem, fourth_sem: @student_subject.fourth_sem, second_sem: @student_subject.second_sem, stud_id: @student_subject.stud_id, subject_id: @student_subject.subject_id, trird_sem: @student_subject.trird_sem } }
