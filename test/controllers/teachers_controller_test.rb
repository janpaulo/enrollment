...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { fname: @teacher.fname, lname: @teacher.lname, mname: @teacher.mname } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { fname: @teacher.fname, lname: @teacher.lname, mname: @teacher.mname } }
