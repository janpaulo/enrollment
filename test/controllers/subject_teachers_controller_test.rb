...
class SubjectTeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject_teacher" do
    assert_difference('SubjectTeacher.count') do
      post subject_teachers_url, params: { subject_teacher: { subject_id: @subject_teacher.subject_id, teacher_id: @subject_teacher.teacher_id } }
    end
  ...
  test "should update subject_teacher" do
    patch subject_teacher_url(@subject_teacher), params: { subject_teacher: { subject_id: @subject_teacher.subject_id, teacher_id: @subject_teacher.teacher_id } }
