...
ActiveRecord::Schema.define(version: 2019_07_24_095716) do
  ...
  create_table "subject_classrooms", force: :cascade do |t|
    t.integer "classroom_id"
    t.integer "subject_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["classroom_id"], name: "index_subject_classrooms_on_classroom_id"
    t.index ["subject_id"], name: "index_subject_classrooms_on_subject_id"
  end
